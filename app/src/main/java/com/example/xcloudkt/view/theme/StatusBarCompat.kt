package com.example.xcloudkt.view.theme
...
object StatusBarCompat {
     ...
     * @param alpha       0 - 255
     */
    fun setStatusBarColor(activity: FragmentActivity?, @ColorInt statusColor: Int, alpha: Int) {
        setStatusBarColor(activity, calculateStatusBarColor(statusColor, alpha))
    }

    fun setStatusBarColor(activity: FragmentActivity?, @ColorInt statusColor: Int) {
     ...
     */
    @JvmOverloads
    fun translucentStatusBar(activity: FragmentActivity?, hideStatusBarBackground: Boolean = false) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    @JvmStatic
    fun changeToLightStatusBar(activity: FragmentActivity?) {
