...
public class EmptyLayout extends LinearLayout {
    ...
    private int mErrorDrawable = R.drawable.default_today;
    private int mEmptyDrawable = R.drawable.default_today;
    private int mLoadingDrawable = R.drawable.default_today;

    private String mErrorMessage = "哎呀！发生了一些错误";
    private String mEmptyMessage = "啥也没有";
    private String mLoadingMessage = "请等一等啦";

    private int mLoadingViewButtonId = R.id.buttonEmpty;
    private int mErrorViewButtonId = R.id.buttonEmpty;
