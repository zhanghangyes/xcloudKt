...
class NetworkUtil {
    ...
    companion object {
        ...
        fun isConnected(): Boolean {
            val cm =
                MyApp.mContext.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
            ...
            if (networkInfo != null && networkInfo.isConnected) {
                ...
                if (type.equals("WIFI", ignoreCase = true)) {
                    ...
                    netWorkType = if (TextUtils.isEmpty(proxyHost))
                        if (isFastMobileNetwork(MyApp.mContext)) NETWORK_TYPE_3G else NETWORK_TYPE_2G
                    else
                        NETWORK_TYPE_WAP
                }
            } else {
